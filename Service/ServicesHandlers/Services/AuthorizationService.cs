namespace Service.ServicesHandlers.Services;
...
public class AuthorizationService : IAuthorizationService
{
    ...
    #region Constructors
    public AuthorizationService(RoleManager<Role> roleManager, UserManager<User> userManager, ApplicationContext dbContext)
    {
